package iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils
...
import iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.buildExceptionForJsError
import iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.parseChallengeData
import iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.parseIntegrityTokenData
import iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.stringToU8
import iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.u8ToBase64
...
class PoTokenWebView(
            ...
            object : android.webkit.WebChromeClient() {
                override fun onConsoleMessage(m: ConsoleMessage): Boolean {
                    if (m.message().contains("Uncaught")) {
                        ...
                        val exception =
                            _root_ide_package_.iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils
    ...
    private suspend fun makeBotguardServiceRequest(
        ...
        withContext(Dispatchers.IO) {
            ...
            if (httpCode != 200) {
                throw _root_ide_package_.iad1tya.echo.kotlinytmusicscraper.utils.poTokenUtils
    ...
    companion object {
        ...
        const val GOOGLE_API_KEY = "YOUR_GOOGLE_API_KEY" // NOSONAR
